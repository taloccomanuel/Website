...
var STATIC_QUIZ_IMAGE_URLS = [
  "https://taloccomanuel.github.io/Website/images/C8image1.png?v=4",
  ...
  <div class="static-quiz-card">
    ...
    <div class="static-quiz-body">
      ...
      <div class="static-quiz-block" data-img="${i+1}">
        ...
        <div class="static-quiz-q">
          <label class="static-quiz-q-label" for="static-quiz-q2-${i}"><span class="static-quiz-q-num">2</span>Can you identify all hazards in the images?</label>
