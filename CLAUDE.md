...
### GAS Projects
| Project | Code File | Embedding Page | GS version-tracker | HTML version-tracker |
|---------|-----------|----------------|--------------------|----------------------|
...
| Equipment Downtime Tracker | `googleAppsScripts/equipment-downtime-tracker/Code.gs` | `live-site-pages/equipment-downtime-tracker.html` | `live-site-pages/gs-versions/equipment-downtime-trackergs.version.txt` | `live-site-pages/html-versions/equipment-downtime-trackerhtml.version.txt` |
